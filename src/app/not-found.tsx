...
export default function NotFound() {
  return (
    <section className="mx-auto max-w-3xl px-4 pt-40 pb-24 text-center sm:px-6">
      <p className="text-xs tracking-[0.28em] text-signal uppercase">404</p>
      ...
      <Link href="/" className="mt-8 inline-block rounded-full bg-action px-6 py-3 font-semibold text-white">
        Home
      </Link>
    </section>
  );
